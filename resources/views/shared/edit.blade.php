...
<x-app-layout>
    <div class="container">
        ...
        <form action="{{ route('shared.update', $shared->id) }}" method="POST">
            ...
            <div class="card content-card mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        @foreach($shared->ips->slice(1) as $extra_ip)
                        <div class="col-12 col-lg-4">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" name="transferrable" id="transferrable" value="1" {{ $shared->transferrable === 1 ? 'checked' : '' }}>
