                        ...
                        <table class="table data-table" id="domain-table">
                            ...
                            @if(!empty($domains))
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap" data-order="{{ $domain->price->usdPerYear() }}">@if($domain->price->usdPerYear() > 0)${{ number_format($domain->price->usdPerYear(), 2) }}@else - @endif</td>
