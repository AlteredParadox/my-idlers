                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">{{ $domain_info->price->next_due_date ? Carbon\Carbon::parse($domain_info->price->next_due_date)->diffForHumans() : '-' }}</span>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="detail-item">
                            ...
                            <div class="col-6">
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">{{ is_null($domain_info->transferrable) ? '-' : (($domain_info->transferrable === 1) ? 'Yes' : 'No') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
