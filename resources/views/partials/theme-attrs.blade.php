{{-- Theme selection, as attributes for the <html> tag.
     ...
     data-bs-theme puts Bootstrap into its native dark mode for the dark
...
@php($__theme = [0 => 'light', 1 => 'dark', 2 => 'neutral-dark', 3 => 'modern-dark'][(int) session('dark_mode', 0)] ?? 'light')
