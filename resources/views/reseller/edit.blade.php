...
<x-app-layout>
    <div class="container">
        ...
        <form action="{{ route('reseller.update', $reseller->id) }}" method="POST">
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            ...
                            <select class="form-select" name="provider_id">
                                @foreach (App\Models\Providers::all() as $provider)
                                    <option value="{{ $provider->id }}" {{ $reseller->provider_id == $provider->id ? 'selected' : '' }}>{{ $provider->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            ...
                            <select class="form-select" name="location_id">
                                @foreach (App\Models\Locations::all() as $location)
                                    <option value="{{ $location->id }}" {{ $reseller->location_id == $location->id ? 'selected' : '' }}>{{ $location->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="link_speed" value="{{ $reseller->link_speed ? ($reseller->link_speed >= 1000 ? $reseller->link_speed / 1000 : $reseller->link_speed) : '' }}" min="0" step="any">
                                <select class="form-select" name="link_speed_type" style="max-width: 80px;">
                                    <option value="Mbps" {{ $reseller->link_speed && $reseller->link_speed < 1000 ? 'selected' : '' }}>Mbps</option>
                                    <option value="Gbps" {{ !$reseller->link_speed || $reseller->link_speed >= 1000 ? 'selected' : '' }}>Gbps</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-2">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" name="transferrable" id="transferrable" value="1" {{ $reseller->transferrable === 1 ? 'checked' : '' }}>
