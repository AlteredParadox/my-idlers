                        ...
                        <table class="table data-table" id="servers-table">
                            ...
                            @if(!empty($servers))
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap" data-order="{{ $server->price->usdPerYear() }}">@if($server->price->usdPerYear() > 0)${{ number_format($server->price->usdPerYear(), 2) }}@else - @endif</td>
